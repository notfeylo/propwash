...
- Real FPV camera LUTs per feed (Phase 5) and a proper analog breakup model once RSSI exists (Phase 4).
- Custom OSD font atlas (MAX7456-style bitmap glyphs) instead of the system monospace font.
