...
export function mountAudioPrompt(audio: LiveAudio, parent: HTMLElement = document.body): void {
  ...
  keys.innerHTML =
    '<b>P</b> battery · <b>Space</b> arm · <b>W/S</b> throttle (Shift fast) · <b>0</b> zero · <b>X</b> kill · <b>C</b> camera · <b>V</b> feed · <b>B</b> beacon · <b>L</b> payload · <b>H</b> hide UI · <b>F</b> fullscreen';
